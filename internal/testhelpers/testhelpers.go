...
var buffaloVersions = []struct {
	...
	{
		"github.com/peterzeller/buffalo-cli/cmd/buffalo",
...
// checking its parent go.mod file says its github.com/peterzeller/buffalo-cli module.
func inCLISource() (bool, error) {
	...
	result := mod == "github.com/peterzeller/buffalo-cli"
	return result, nil
}
